...
<form action="../controle/usuariocontrole.php?op=buscar" method="post" name="cadu">
    <fieldset>
        ...
        <br>
        <label><input type="radio" name="rdfiltro" id="login" value="login">Login</label>
        <br>
        <label><input type="radio" name="rdfiltro" id="parteslogin" value="parteslogin">Partes do Login</label>
        <br>
